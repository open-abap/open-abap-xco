INTERFACE if_xco_gen_cds_s_fo_ann_value PUBLIC.
  METHODS build RETURNING VALUE(ro_builder) TYPE REF TO if_xco_gen_cds_s_fo_ann_value.
  ...
  METHODS add_number IMPORTING iv_value TYPE i RETURNING VALUE(ro_builder) TYPE REF TO if_xco_gen_cds_s_fo_ann_value.
